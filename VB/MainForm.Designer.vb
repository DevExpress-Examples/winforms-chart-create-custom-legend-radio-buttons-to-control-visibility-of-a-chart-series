Namespace CustomCheckboxesInLegendViewAndBehavior
	Partial Public Class mainForm
		...
		Private Sub InitializeComponent()
			...
			Dim seriesPoint1 As New DevExpress.XtraCharts.SeriesPoint("1", New Object() { (CObj(3R))})
			Dim seriesPoint2 As New DevExpress.XtraCharts.SeriesPoint("2", New Object() { (CObj(12R))})
			Dim seriesPoint3 As New DevExpress.XtraCharts.SeriesPoint("3", New Object() { (CObj(16R))})
			Dim seriesPoint4 As New DevExpress.XtraCharts.SeriesPoint("4", New Object() { (CObj(21R))})
			Dim pointSeriesView1 As New DevExpress.XtraCharts.PointSeriesView()
			Dim series2 As New DevExpress.XtraCharts.Series()
			Dim seriesPoint5 As New DevExpress.XtraCharts.SeriesPoint("1", New Object() { (CObj(2R))})
			Dim seriesPoint6 As New DevExpress.XtraCharts.SeriesPoint("2", New Object() { (CObj(12R))})
			Dim seriesPoint7 As New DevExpress.XtraCharts.SeriesPoint("3", New Object() { (CObj(25R))})
			Dim seriesPoint8 As New DevExpress.XtraCharts.SeriesPoint("4", New Object() { (CObj(35R))})
			Dim lineSeriesView1 As New DevExpress.XtraCharts.LineSeriesView()
			Dim series3 As New DevExpress.XtraCharts.Series()
			Dim seriesPoint9 As New DevExpress.XtraCharts.SeriesPoint("1", New Object() { (CObj(15R))})
			Dim seriesPoint10 As New DevExpress.XtraCharts.SeriesPoint("2", New Object() { (CObj(18R))})
			Dim seriesPoint11 As New DevExpress.XtraCharts.SeriesPoint("3", New Object() { (CObj(25R))})
			Dim seriesPoint12 As New DevExpress.XtraCharts.SeriesPoint("4", New Object() { (CObj(33R))})
